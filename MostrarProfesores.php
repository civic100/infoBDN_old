...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="estilos-css/Estilo-MostrarProfesores.css" />
    ...
    <body>
        ...
        <div class="contenedor-central">
            <h3 class="txt-contenedor-central">Profesores</h3>
        </div>
                ...
                <?php
                    ...
                    if($conexion == false){
                        ...
                        if ($consulta== false){
                            ...
                            generarTablaProfesores2($consulta);
                        }
                    }
                ?>
            </div>
